...
(function($, version)
{
      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<div style="position: absolute;top:0px " class="jPicker"><div  style="position: absolute" class="Icon"><div style="position: absolute;width:80px; height:40px;" class="Color">&nbsp;</div><div style="position: absolute" class="Alpha">&nbsp;</div><div style="position: absolute;width:80px; height:40px; background: no-repeat" class="Image" title="Click To Open Color Picker">&nbsp;</div><div style="position: absolute" class="Container">&nbsp;</div></div></div>');
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: 'src/assets/gui/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
          ...
          picker:
          {
            file: 'picker.png', /* Color Picker icon */
            width: 80,
            height: 40
          }
        },
