...
Oval.prototype.hitTest = function(hitX,hitY) {
    var dx = this.coordinates[0] - hitX;
    var dy = this.coordinates[1] - hitY;
    console.log(this.coordinates,hitX,hitY,hitX > this.coordinates[0] , hitX < this.coordinates[0] + this.coordinates[2] ,hitY > this.coordinates[1] , hitY < this.coordinates[1] + this.coordinates[3]);
    return(hitX > this.coordinates[0] && hitX < this.coordinates[0] + this.coordinates[2] && hitY > this.coordinates[1] && hitY < this.coordinates[1] + this.coordinates[3])
    //return(dx*dx + dy*dy < this.coordinates[2]*this.coordinates[3]);
}
Rectangle.prototype.hitTest = function(hitX,hitY) {
    return(hitX > this.coordinates[0] && hitX < this.coordinates[0] + this.coordinates[2] && hitY < this.coordinates[1] && hitY < this.coordinates[1] + this.coordinates[3])
}
/* Storke style event */
    ...
    execute: function(wbevent, firstexecute) {
        ...
        if(type === "beginpath") {
            ...
            this.context.clearRect(wbevent.coordinates[0],
                              wbevent.coordinates[1],
                              wbevent.width*5*_sizePicked,
                              wbevent.height*5*_sizePicked);
